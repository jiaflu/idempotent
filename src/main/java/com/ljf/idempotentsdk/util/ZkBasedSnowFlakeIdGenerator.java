...
public class ZkBasedSnowFlakeIdGenerator implements TrxIdGenerator {
    ...
    public ZkBasedSnowFlakeIdGenerator() {}
    ...
    public static void main(String[] args) {
        ZkBasedSnowFlakeIdGenerator zkBasedSnowFlakeIdGenerator = new ZkBasedSnowFlakeIdGenerator();
        long trxId = zkBasedSnowFlakeIdGenerator.getCurrentTrxId("aa");
